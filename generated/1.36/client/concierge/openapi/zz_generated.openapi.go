...
import (
	v1alpha1 "go.pinniped.dev/generated/1.36/apis/concierge/identity/v1alpha1"
	loginv1alpha1 "go.pinniped.dev/generated/1.36/apis/concierge/login/v1alpha1"
...
func GetOpenAPIDefinitions(ref common.ReferenceCallback) map[string]common.OpenAPIDefinition {
	return map[string]common.OpenAPIDefinition{
		v1alpha1.KubernetesUserInfo{}.OpenAPIModelName():                schema_apis_concierge_identity_v1alpha1_KubernetesUserInfo(ref),
		v1alpha1.UserInfo{}.OpenAPIModelName():                          schema_apis_concierge_identity_v1alpha1_UserInfo(ref),
		v1alpha1.WhoAmIRequest{}.OpenAPIModelName():                     schema_apis_concierge_identity_v1alpha1_WhoAmIRequest(ref),
		v1alpha1.WhoAmIRequestList{}.OpenAPIModelName():                 schema_apis_concierge_identity_v1alpha1_WhoAmIRequestList(ref),
		v1alpha1.WhoAmIRequestSpec{}.OpenAPIModelName():                 schema_apis_concierge_identity_v1alpha1_WhoAmIRequestSpec(ref),
		v1alpha1.WhoAmIRequestStatus{}.OpenAPIModelName():               schema_apis_concierge_identity_v1alpha1_WhoAmIRequestStatus(ref),
		loginv1alpha1.ClusterCredential{}.OpenAPIModelName():            schema_apis_concierge_login_v1alpha1_ClusterCredential(ref),
		loginv1alpha1.TokenCredentialRequest{}.OpenAPIModelName():       schema_apis_concierge_login_v1alpha1_TokenCredentialRequest(ref),
		loginv1alpha1.TokenCredentialRequestList{}.OpenAPIModelName():   schema_apis_concierge_login_v1alpha1_TokenCredentialRequestList(ref),
		loginv1alpha1.TokenCredentialRequestSpec{}.OpenAPIModelName():   schema_apis_concierge_login_v1alpha1_TokenCredentialRequestSpec(ref),
		loginv1alpha1.TokenCredentialRequestStatus{}.OpenAPIModelName(): schema_apis_concierge_login_v1alpha1_TokenCredentialRequestStatus(ref),
...
func schema_apis_concierge_identity_v1alpha1_KubernetesUserInfo(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
				...
				Properties: map[string]spec.Schema{
					"user": {
						SchemaProps: spec.SchemaProps{
							...
							Ref:         ref(v1alpha1.UserInfo{}.OpenAPIModelName()),
						},
					},
					"audiences": {
						SchemaProps: spec.SchemaProps{
		...
		Dependencies: []string{
			v1alpha1.UserInfo{}.OpenAPIModelName()},
	}
}
...
func schema_apis_concierge_identity_v1alpha1_WhoAmIRequest(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
			...
			SchemaProps: spec.SchemaProps{
				...
				Properties: map[string]spec.Schema{
					...
					"spec": {
						SchemaProps: spec.SchemaProps{
							Default: map[string]interface{}{},
							Ref:     ref(v1alpha1.WhoAmIRequestSpec{}.OpenAPIModelName()),
						},
					},
					"status": {
						SchemaProps: spec.SchemaProps{
							Default: map[string]interface{}{},
							Ref:     ref(v1alpha1.WhoAmIRequestStatus{}.OpenAPIModelName()),
						},
					},
				},
			},
		...
		Dependencies: []string{
			v1alpha1.WhoAmIRequestSpec{}.OpenAPIModelName(), v1alpha1.WhoAmIRequestStatus{}.OpenAPIModelName(), metav1.ObjectMeta{}.OpenAPIModelName()},
	}
}
...
func schema_apis_concierge_identity_v1alpha1_WhoAmIRequestList(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
						...
						SchemaProps: spec.SchemaProps{
							...
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
										Default: map[string]interface{}{},
										Ref:     ref(v1alpha1.WhoAmIRequest{}.OpenAPIModelName()),
									},
								},
							},
						},
		...
		Dependencies: []string{
			v1alpha1.WhoAmIRequest{}.OpenAPIModelName(), metav1.ListMeta{}.OpenAPIModelName()},
	}
}
...
func schema_apis_concierge_identity_v1alpha1_WhoAmIRequestSpec(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "Spec is always empty for a WhoAmIRequest.",
				Type:        []string{"object"},
			},
		},
	}
...
func schema_apis_concierge_identity_v1alpha1_WhoAmIRequestStatus(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "Status is set by the server in the response to a WhoAmIRequest.",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"kubernetesUserInfo": {
						SchemaProps: spec.SchemaProps{
							...
							Default:     map[string]interface{}{},
							Ref:         ref(v1alpha1.KubernetesUserInfo{}.OpenAPIModelName()),
						},
					},
				},
		...
		Dependencies: []string{
			v1alpha1.KubernetesUserInfo{}.OpenAPIModelName()},
	}
}
...
func schema_apis_concierge_login_v1alpha1_TokenCredentialRequest(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
			...
			SchemaProps: spec.SchemaProps{
				...
				Properties: map[string]spec.Schema{
					...
					"spec": {
						SchemaProps: spec.SchemaProps{
							Default: map[string]interface{}{},
							Ref:     ref(loginv1alpha1.TokenCredentialRequestSpec{}.OpenAPIModelName()),
						},
					},
					"status": {
						SchemaProps: spec.SchemaProps{
							Default: map[string]interface{}{},
							Ref:     ref(loginv1alpha1.TokenCredentialRequestStatus{}.OpenAPIModelName()),
						},
					},
				},
			},
		...
		Dependencies: []string{
			loginv1alpha1.TokenCredentialRequestSpec{}.OpenAPIModelName(), loginv1alpha1.TokenCredentialRequestStatus{}.OpenAPIModelName(), metav1.ObjectMeta{}.OpenAPIModelName()},
	}
}
...
func schema_apis_concierge_login_v1alpha1_TokenCredentialRequestList(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				...
				Properties: map[string]spec.Schema{
					...
					"items": {
						SchemaProps: spec.SchemaProps{
							Description: "Items is a list of TokenCredentialRequest.",
							Type:        []string{"array"},
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
										Default: map[string]interface{}{},
										Ref:     ref(loginv1alpha1.TokenCredentialRequest{}.OpenAPIModelName()),
									},
								},
							},
						},
		...
		Dependencies: []string{
			loginv1alpha1.TokenCredentialRequest{}.OpenAPIModelName(), metav1.ListMeta{}.OpenAPIModelName()},
	}
}
...
func schema_apis_concierge_login_v1alpha1_TokenCredentialRequestSpec(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "Specification of a TokenCredentialRequest, expected on requests to the Pinniped API.",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"token": {
						SchemaProps: spec.SchemaProps{
...
func schema_apis_concierge_login_v1alpha1_TokenCredentialRequestStatus(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "Status of a TokenCredentialRequest, returned on responses to the Pinniped API.",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"credential": {
						SchemaProps: spec.SchemaProps{
							Description: "A Credential will be returned for a successful credential request.",
							Ref:         ref(loginv1alpha1.ClusterCredential{}.OpenAPIModelName()),
						},
					},
					"message": {
						SchemaProps: spec.SchemaProps{
		...
		Dependencies: []string{
			loginv1alpha1.ClusterCredential{}.OpenAPIModelName()},
	}
}
