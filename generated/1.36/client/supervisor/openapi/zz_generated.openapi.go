...
import (
	v1alpha1 "go.pinniped.dev/generated/1.36/apis/supervisor/clientsecret/v1alpha1"
...
func GetOpenAPIDefinitions(ref common.ReferenceCallback) map[string]common.OpenAPIDefinition {
	return map[string]common.OpenAPIDefinition{
		v1alpha1.OIDCClientSecretRequest{}.OpenAPIModelName():       schema_apis_supervisor_clientsecret_v1alpha1_OIDCClientSecretRequest(ref),
		v1alpha1.OIDCClientSecretRequestList{}.OpenAPIModelName():   schema_apis_supervisor_clientsecret_v1alpha1_OIDCClientSecretRequestList(ref),
		v1alpha1.OIDCClientSecretRequestSpec{}.OpenAPIModelName():   schema_apis_supervisor_clientsecret_v1alpha1_OIDCClientSecretRequestSpec(ref),
		v1alpha1.OIDCClientSecretRequestStatus{}.OpenAPIModelName(): schema_apis_supervisor_clientsecret_v1alpha1_OIDCClientSecretRequestStatus(ref),
...
func schema_apis_supervisor_clientsecret_v1alpha1_OIDCClientSecretRequest(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
			...
			SchemaProps: spec.SchemaProps{
				...
				Properties: map[string]spec.Schema{
					...
					"spec": {
						SchemaProps: spec.SchemaProps{
							Default: map[string]interface{}{},
							Ref:     ref(v1alpha1.OIDCClientSecretRequestSpec{}.OpenAPIModelName()),
						},
					},
					"status": {
						SchemaProps: spec.SchemaProps{
							Default: map[string]interface{}{},
							Ref:     ref(v1alpha1.OIDCClientSecretRequestStatus{}.OpenAPIModelName()),
						},
					},
				},
		...
		Dependencies: []string{
			v1alpha1.OIDCClientSecretRequestSpec{}.OpenAPIModelName(), v1alpha1.OIDCClientSecretRequestStatus{}.OpenAPIModelName(), metav1.ObjectMeta{}.OpenAPIModelName()},
	}
}

func schema_apis_supervisor_clientsecret_v1alpha1_OIDCClientSecretRequestList(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				...
				Properties: map[string]spec.Schema{
					...
					"items": {
						SchemaProps: spec.SchemaProps{
							Description: "Items is a list of OIDCClientSecretRequest.",
							Type:        []string{"array"},
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
										Default: map[string]interface{}{},
										Ref:     ref(v1alpha1.OIDCClientSecretRequest{}.OpenAPIModelName()),
									},
								},
							},
						},
		...
		Dependencies: []string{
			v1alpha1.OIDCClientSecretRequest{}.OpenAPIModelName(), metav1.ListMeta{}.OpenAPIModelName()},
	}
}

func schema_apis_supervisor_clientsecret_v1alpha1_OIDCClientSecretRequestSpec(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "Spec of the OIDCClientSecretRequest.",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"generateNewSecret": {
						SchemaProps: spec.SchemaProps{
							Description: "Request a new client secret to for the OIDCClient referenced by the metadata.name field.",
							Default:     false,
							Type:        []string{"boolean"},
							Format:      "",
						},
					...
					"revokeOldSecrets": {
						SchemaProps: spec.SchemaProps{
							Description: "Revoke the old client secrets associated with the OIDCClient referenced by the metadata.name field.",
							Default:     false,
							Type:        []string{"boolean"},
							Format:      "",
						},
...
func schema_apis_supervisor_clientsecret_v1alpha1_OIDCClientSecretRequestStatus(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "Status of the OIDCClientSecretRequest.",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"generatedSecret": {
						SchemaProps: spec.SchemaProps{
							Description: "The unencrypted OIDC Client Secret. This will only be shared upon creation and cannot be recovered if lost.",
							Type:        []string{"string"},
							Format:      "",
						},
					},
					"totalClientSecrets": {
						SchemaProps: spec.SchemaProps{
							Description: "The total number of client secrets associated with the OIDCClient referenced by the metadata.name field.",
							Default:     0,
							Type:        []string{"integer"},
							Format:      "int32",
						},
				...
				Required: []string{"totalClientSecrets"},
			},
		},
	}
}
